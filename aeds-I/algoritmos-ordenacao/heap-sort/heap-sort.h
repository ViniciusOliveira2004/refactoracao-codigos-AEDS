...
/** Reestrutura uma subárvore para manter a propriedade do heap máximo:
  *  @param vetor O vetor a ser reestruturado
  *  @param esq O índice do elemento pai da subárvore
  *  @param dir O índice do último elemento da subárvore */
void refazSubArvore(Vetor vetor, Indice esq, Indice dir); 
    
/** Constrói o heap a partir do último pai até a raiz.
 *  @param vetor O vetor a ser transformado em heap
 *  @param tamanho O número de elementos no vetor */
void constroiHeap(Vetor vetor, Indice tamanho);

/** Ordena o vetor utilizando o algoritmo HeapSort.
